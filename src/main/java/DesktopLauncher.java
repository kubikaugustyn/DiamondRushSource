...
/*
This file is an edited copy of file org.recompile.freej2me.FreeJ2ME
*/
...
public class DesktopLauncher {
    ...
    public DesktopLauncher() {
        /*String name="/ui.f";
        InputStream ui = name.getClass().getResourceAsStream(name);//DesktopLauncher.class.getResourceAsStream("/ui.f");
        ...
        Mobile.getPlatform().loader = new MIDletLoader(new URL[]{GloftDIRU.class.getProtectionDomain().getCodeSource().getLocation()});
        config.init();
        ...
        lcdWidth = 240;
        lcdHeight = 320;
        config.settings.put("width", String.valueOf(lcdWidth));
        config.settings.put("height", String.valueOf(lcdHeight));

        settingsChanged();

        Mobile.getPlatform().runJar(GloftDIRU.class);
    }
    ...
    public static void printByteArr(byte[] data) {
        if (data == null) {
        ...
        System.out.print(") ");
        for (byte letter : data) {
            System.out.print(letter & 0xFF);
            System.out.print(' ');
        }
        System.out.println();
    }

    public static void printByteArr(byte[] data,String caption) {
        System.out.print(caption);
        System.out.print(' ');
        DesktopLauncher.printByteArr(data);
    }
}
